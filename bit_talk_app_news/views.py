...
from .serializers import (
    ...
    NewsFeedSerializer)
from .models import News_articles, NewsFeed, STATUS_CHOICES
...
class NewsViewSet(ModelViewSet):
    ...
    def report_comment(self, request, *args, **kwargs):
        ...
        try:
            _report_comment('news', kwargs['comment_id'], reported_reason)
        except Exception as e:
        ...
        try:
            if comment_status in dict(STATUS_CHOICES):
                if comment_status == 'Approved':
                    _approve_comment('news', kwargs['comment_id'], comment_status)
                _update_comment_status('news', kwargs['comment_id'], comment_status)
            else:
