...
class MongoUser(Document):
    ...
    first_name = fields.StringField(blank=True, verbose_name='first name', required=True)
    last_name = fields.StringField(blank=True, verbose_name='last name')
    password = fields.StringField(required=True, verbose_name='password', min_length=8)
