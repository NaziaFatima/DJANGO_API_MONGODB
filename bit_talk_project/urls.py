...
from bit_talk_root.views import MongoUserViewSet, UserProfileViewSet
...
router.register('users', UserProfileViewSet, 'users')
router.register('posts', PostsViewSet, 'posts')
router.register('moderation-keywords', ModerationKeywordViewSet, 'ModerationKeywordsAPI') # noqa :501
